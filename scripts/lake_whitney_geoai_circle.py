#!/usr/bin/env python3
"""
Generate precomputed Sentinel-2 change GeoJSONs for the Lake Whitney circular study area.

This mirrors the DFW7 change stack exporter, but uses a large circular buffer that
encapsulates the entire lake instead of the historical shoreline polygon.

Outputs (per year pair):
  public/data/lake_whitney_circle/lake_whitney_circle_<year1>_<year2>.geojson
  public/data/lake_whitney_circle/lake_whitney_circle_<year1>_<year2>_stats.json
"""
...
SITE_ID = "lake_whitney_circle"
SITE_NAME = "Lake Whitney Circular Study Area"
SITE_CENTER = (-97.405, 31.98)  # (lng, lat)
SITE_RADIUS_METERS = 18000
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Lake Whitney change exporter")
    parser.add_argument(
        "--output-dir",
