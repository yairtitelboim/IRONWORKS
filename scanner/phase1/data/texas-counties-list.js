/**
 * Valid Texas Counties List
 * Used for validation to filter out false positives
 */
...
export const TEXAS_COUNTIES = [
  ...
  'Hardeman', 'Hardin', 'Harris', 'Harrison', 'Hartley', 'Haskell', 'Hays',
  'Hemphill', 'Henderson', 'Hidalgo', 'Hill', 'Hockley', 'Hood', 'Hopkins',
  ...
  'Kerr', 'Kimble', 'King', 'Kinney', 'Kleberg', 'Knox', 'Lamar', 'Lamb',
  'Lampasas', 'La Salle', 'Lavaca', 'Lee', 'Leon', 'Liberty', 'Limestone',
  'Lipscomb', 'Live Oak', 'Llano', 'Loving', 'Lubbock', 'Lynn', 'McCulloch',
  'McLennan', 'McMullen', 'Madison', 'Marion', 'Martin', 'Mason', 'Matagorda',
 ...
 */
export function isValidTexasCounty(county) {
  if (!county) return false;
  const normalized = county.trim();
  return TEXAS_COUNTIES.includes(normalized);
}

/**
 * Normalize county name for lookup
 */
export function normalizeCountyName(county) {
