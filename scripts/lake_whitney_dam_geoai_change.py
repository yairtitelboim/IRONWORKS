#!/usr/bin/env python3
"""
Generate Sentinel-2 change GeoJSON layers for the Lake Whitney Dam AOI.

This mirrors the Lakeside Village exporter but uses a Lake Whitney Dam
center point and dataset prefix.

Outputs:
  public/data/lake_whitney_dam/lake_whitney_dam_circle_<year1>_<year2>.geojson
  public/data/lake_whitney_dam/lake_whitney_dam_circle_<year1>_<year2>_stats.json
"""
...
SITE_ID = "lake_whitney_dam_circle"
SITE_NAME = "Lake Whitney Dam Circular AOI"
SITE_CENTER = (-97.367, 31.867)  # (lng, lat)
SITE_RADIUS_METERS = 4500
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Lake Whitney Dam change exporter")
    parser.add_argument(
        "--output-dir",
        default=os.path.join("public", "data", "lake_whitney_dam"),
